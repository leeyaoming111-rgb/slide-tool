...
| `model-reference.xlsx` | "The New Auckland Case Model" V4 workbook (UoA Case Programme) | — | The canonical section-by-section presentation script: sentence templates, timings, and section jobs. **Primary source for `docs/COPY_RULES.md`**; mine it for wording, not layout |
